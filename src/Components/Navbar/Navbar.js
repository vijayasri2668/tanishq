  ...
  return (
    <nav>
     ...
     <button className='menulogo' onClick={handleChange}>
          <img src='https://img.icons8.com/ios-glyphs/2x/menu.png'/>
     </button>
     <div className="menu">{showmenu && <Menu />}</div>
       
        <Link to='/' className='Link1'><img src='https://d33wubrfki0l68.cloudfront.net/9e4134ed541e29c1678c10ae60ac04ac89a622fe/33276/static/gspann-logo-118e08f639b657b898557aacd9e34333.svg'/></Link>
